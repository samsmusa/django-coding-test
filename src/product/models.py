...
class ProductVariant(TimeStampMixin):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='pvarinat')
...
class ProductVariantPrice(TimeStampMixin):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='pvariantprice')
